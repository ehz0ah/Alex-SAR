...
void *writerThread(void *conn)
{
	...
	{
		char ch;
		printf("Command (f = Forward, b = Backward, l = Turn Left, r = Turn Right, s = Stop, c = Clear Stats, z = Claw , u = Green Siren , j = Red Siren , y = Celebrate , g = Get Stats, q = Exit)\n");
		scanf("%c", &ch);
